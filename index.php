...
.gallery .movable > div {
  ...
  <body id="page-top" data-spy="scroll" data-target=".navbar-custom">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      ...
      <section id="intro" class="carousel-header"> <!-- Section 1 -->
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="img/gandhi-images/gandhi-background-black.gif" alt="Fresh ingredients">
        ...
        <p>Our ingredients are sourced freshly each day and prepared by our award-winning head chef. Ready yourself for a journey of irresistable flavour.</p>
      </div>
    </div>
    ...
    <div class="item">
      <img src="img/gandhi-images/gandhi-background-4-black.gif" alt="Great tasting food">
        ...
        <p>Our service and welcoming atmosphere is derived from our family tradition, that was first implemented in the Gandhi Restaurant by our father in 1979.</p>
      </div>
    </div>
    ...
    <div class="item">
      <img src="img/gandhi-images/gandhi-background-3-black.gif" alt="Authentic indian flavours">
        ...
        <p>Our menu has been evolving for over 3 decades. Our inspiration comes from our heritage and our experience across Indian cuisine.</p>
      </div>
    </div>
  </div>
  ...
  <a class="right carousel-control" href="#myCarousel" data-slide="next">
    ...
    <span class="sr-only">Next</span>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <p class="card-text">The Gandhi Restaurant is the perfect setting for a business event. We cater for all events such as private meetings and large parties.</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    <img class="card-img-top" src="img/gandhi-images/gandhi-c2.gif" alt="Card image cap">
                        <div class="card-block">
                            ...
                            <p class="card-text">Celebrate your special occasion in a relaxing and luxurious atmosphere. Our team will be happy to help you arrange your perfect experience.</p>
                        </div>
                </div>
            </div>
                ...
                <div class="card">
                    <img class="card-img-top" src="img/gandhi-images/gandhi-c3.gif" alt="Card image cap">
                        <div class="card-block">
                            ...
                            <p class="card-text">The Gandhi Restaurant is built on family tradition, as such we welcome families into our friendly environment. All ages can enjoy the Gandhi experience!</p>
                        </div>
                </div>
            </div>
      ...
      <section id="menu"> <!-- Section 4 -->
          <!-- Gandhi menu in-house -->
    
    <div id="gandhi-menu" class="container">
        <h2 class="menu-title">Menu</h2>
        <div style="border-style: solid; border-color: #151515; border-width: 1px; padding-top: 10px; padding-bottom: 50px; margin-bottom: 50px;" class="gallery">
            <div class="row">
    ...
    <div id="Starters" class="menu-container">
        ...
        <div class="container">     
          ...
          <p>Popular appetiser prepared with chick peas, onions and potatoes, parcelled in small crusty puris then topped with yoghurt and tangy tamarind sauce.</p>
                </div>
        ...
        <div class="container">     
          ...
          <p>Diced chicken cooked with cucumber in tangy spicy sauce, Puri contains egg, flour &amp; sesame seeds served on thin fried bread.</p>
                </div>
          ...
          <p>Tender pieces of chicken or filleted lamb marinated in yoghurt, ground cumin, and medium spices, then roasted in the clay oven. Marinated in mustard paste, gram flour, yoghurt &amp; soya.</p>
                </div>
        ...
        <div class="container">     
          ...
          <p>Pieces of Chicken Tikka, Lamb Tikka and Sheek Kebab, marinated in mustard paste, gram flour, yoghurt &amp; soya.</p>
                </div>
        ...
        <div class="container">     
          ...
          <p>Mouth watering fillet of Sea Bass matured in a rich spicy marinade of coriander, garlic and trace of olive oil, then delicately grilled.</p>
                </div>
          ...
          <p>Two whole succulent King Prawns marinated in coriander, garlic and medium spices, then grilled until tender and golden.</p>
                </div>
    ...
    <div id="Traditional-dishes" class="menu-container">
        <div style="margin-left: 20px;">
            ...
            <p style="font-size: 12px;">The following can be prepared with Vegetable, Chicken or Lamb, Tiger Prawns. Rice not included <br> Add £1.00 for Chicken, Lamb or Lamb Tikka <br> Add £4.00 for King Prawn</p>
        </div>
    ...
    <div id="Sizzlers" class="menu-container">
        <div style="margin-left: 20px;">
            ...
            <p style="font-size: 12px;">The following dishes are prepared and marinated with yoghurt, mustard paste, gram flour, soya, ground cumin and medium spices then roasted in the clay oven. Served with salad &amp; mint sauce.</p>
        </div>
    ...
    <div id="Biriani" class="menu-container">
        <div style="margin-left: 20px;">
            ...
            <p style="font-size: 12px;">The finest Basmati rice cooked in authentic style topped with whole boiled egg. Served in Indian pot with vegetable curry side-dish.</p>
        </div>
    ...
    <div id="Speciality" class="menu-container">
        ...
        <div class="container">     
          ...
          <p>A traditional dish consisting of compartments of assorted dishes with various flavours. Served with rice &amp; nan.</p>
                </div>
          ...
          <p>Mouth-watering fillets of Sea Bass matured in a rich spicy marinade of coriander, garlic and trace of olive oil then delicately grilled. Served with medium sauce.</p>
                </div>
              </div>
            </div>  
        ...
        <div class="container">     
          ...
          <p>Mouth-watering fillet of Salmon matured in a rich spicy marinade of coriander, garlic and trace of olive oil then delicately grilled. Served with medium sauce.</p>
                </div>
          ...
          <p>Whole succulent King Prawns cooked in a rich sauce with green peppers and green chillies, flamed with Sambuca. Served sizzling.</p>
                </div>
    ...
    <div id="Regional" class="menu-container">
        <div style="margin-left: 20px;">
            ...
            <p style="font-size: 12px;">The following can be prepared with vegetable, chicken, lamb or tiger prawns. Rice is not included.<br>Add £1.00 for lamb<br>Add £4.00 for king prawn.</p>
        </div>
        ...
        <div class="container">     
         ...
         <div class="container">     
          ...
          <p>Cooked in cubed onions, green peppers, garlic, green chillies, and fresh tomatoes. A little dry but superb. Hot served with separate madras sauce.</p>
                </div>
       ...
       <div class="gandhi-divider">
        <div class="container">
            ...
            <div class="col-sm-6 col-md-offset-1 location-map">
              ...
              src="https://www.google.com/maps/embed/v1/place?key=AIzaSyAs2aeUa6sQN6MIg3LabTTlTM--QbKwk8M&q=139-141+Kingston Rd,Portsmouth+PO2+7EB" allowfullscreen></iframe>
            </div>
  </div>  
</div>
    </div>
      ...
      <div class="col-sm-10">
       ...
       <button style="margin-top: 15px; margin-left: 10px;" type="submit" class="btn btn-primary">Confirm</button> 
        ...
        <p class="text-muted" style="float: right; font-size: 12px; margin-top: 15px;">Powered by<img href="https://www.accentpos.com" style="width: 50px; padding-left: 10px;" src="img/gandhi-images/APOS-logo.png"></p>
          ...
          <div class="container large-form"> <!-- Large form start-->
              <div class="col-md-12">
     <form method="post"> 
    <div style="padding-bottom: 50px;" class="row">    
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">Thanks for choosing The Gandhi Restaurant, Portsmouth. We're currently processing your booking, and will confirm it with you via the email address you have provided.
          <br>
    ...
    <div class="row">
      <div class="col-md-5 mb-5">
        <ul class="list-unstyled list-spaced">
          ...
          <li class="text-muted">
             We have been serving the best Indian cuisine in Portsmouth since 1979. We have spent over three decades pioneering our menu into what is available today. Our head chef has introduced many new dishes but we retain many of the original recipes that our father implemented when he first opened the Restaurant. We are always keen to hear your ideas for how we can continue to serve you best so please do not hesitate to contact us!
